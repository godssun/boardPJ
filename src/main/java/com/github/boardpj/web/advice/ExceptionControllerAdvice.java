package com.github.boardpj.web.advice;

import com.github.boardpj.service.exceptions.InvalidValueException;
import com.github.boardpj.service.exceptions.NotAcceptException;
import com.github.boardpj.service.exceptions.NotFoundException;
import com.github.boardpj.service.exceptions.*;
...
public class ExceptionControllerAdvice {
	...
	public String handlePasswordMismatchException(PasswordMismatchException pme) {
		log.error("Client 요청에 문제가 있어 다음처럼 출력합니다. " + pme.getMessage());
